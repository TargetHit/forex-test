...
"items_favoriting" | 
/** Can be disabled to forbid storing chart properties to the localstorage while
 *  allowing to save other properties. The other properties are favorites in the Charting Library 
 * and Watchlist symbols and some panels states in the Trading Terminal @default true @default true */
